...
#define FUEGO_AIRCON1_HDR_MARK   (3500 + 20) // + 74
#define FUEGO_AIRCON1_HDR_SPACE  (1630 - 40)// - 84
#define FUEGO_AIRCON1_BIT_MARK   (520 - 5) // 516 measured
#define FUEGO_AIRCON1_ONE_SPACE  (1165 + 15 ) // - 21
#define FUEGO_AIRCON1_ZERO_SPACE (520 + 5) // - 19
